...
const privacyPolicy = (props) => (
    <Aux>
        <div className={classes.PrivacyPolicy}>
            ...
            <h4>Effective date: July 28, 2019</h4>

            <p>Holdfast Invoice (“us”, “we”, or “our”) operates the Holdfast Invoice mobile application (hereinafter referred to as the “Service”).</p>
            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. The Privacy Policy for Holdfast Invoice has been created with the help of TermsFeed.</p>
            ...
            <h3>DEFINITIONS</h3>
            <p><strong>Service:</strong> Service is the Holdfast Invoice mobile application operated by Holdfast Invoice</p>
            ...
            <h3>USE OF DATA</h3>
            <p>Holdfast Invoice uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>Holdfast Invoice will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h3>DISCLOSURE OF DATA</h3>

            <h4>LEGAL REQUIREMENTS</h4>

            <p>Holdfast Invoice may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Holdfast Invoice</li>
